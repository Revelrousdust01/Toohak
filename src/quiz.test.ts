...
describe('V1 - Test adminQuizTrashEmpty', () => {
  ...
  test('QuizId does not refer to valid quiz', () => {
    ...
    v1RequestAdminAuthRegister(email, password, lastName, firstName);
    const quiz3 = v1RequestAdminQuizCreate(register.token as string, quizName, quizDescription);
    const quiz4 = v1RequestAdminQuizCreate(register.token as string, 'Special quiz name', quizDescription);
    requestAdminQuizRemove(register.token as string, quiz3.quizId as number);
    requestAdminQuizRemove(register.token as string, quiz4.quizId as number);
...
describe('V2 - Test adminQuizTrashEmpty', () => {
  ...
  test('QuizId does not refer to valid quiz', () => {
    ...
    v1RequestAdminAuthRegister(email, password, lastName, firstName);
    const quiz3 = v2RequestAdminQuizCreate(register.token as string, quizName, quizDescription);
    const quiz4 = v2RequestAdminQuizCreate(register.token as string, 'Special quiz name', quizDescription);
    requestAdminQuizRemove(register.token as string, quiz3.quizId as number);
    requestAdminQuizRemove(register.token as string, quiz4.quizId as number);
